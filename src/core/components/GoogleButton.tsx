...
export const GoogleButton: React.FC<GoogleButtonProps> = ({ label }) => {
  ...
  return (
    <button
      className="flex items-center duration-150 border-2 border-transparent rounded-sm shadow select-none hover:text-white hover:bg-pri-500 hover:border-pri-500"
      onClick={() => {
